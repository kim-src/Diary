...
### 🎁 References
> - [코딩애플 유튜브의 DB 선택 가이](https://www.youtube.com/watch?v=ZVuHZ2Fjkl4&list=PLxJi-PaTyzwDlmPcNMYRvfrDBK0486DKO&index=2)
...
<!-- Contents -->
### 🔔 "메타코드M" 으로부터의 연락
> - 메타코드M 이직 인력 담당자의 링크드인 메시지를 수령 받음
> - 그래서 잡코리아 이력서 및 깃허브/링크드인/벨로그 주소를 전달하였음
> - 하지만 현재 이공계열 기업 근무중이기에 개발자 자체의 경력은 없는 상태임
> - 그리고 한창 개인 프로젝트를 진행하며 개발 실력을 쌓는 중이었기에 기대는 하지 않음
...
### 재택 여부
- 필수는 아니지만 가능하다면 좋겠습니다.

### 희망 직군
1. 데이터 분석: 관련 국제논문 5편 보유(석사과정 당시 작성)
2. PM, PO, CM
3. 백엔드 웹 개발자
...
이렇게 답변 드리겠습니다!
그런데 개발자 자체의 경력은 없습니다..

강원대학교 지질학과 학부 및 일반대학원(세부전공: 지하수) 졸업 후

현재 이공계열 엔지니어링 서비스 기업(싱크홀 조사)에 근무중(총 2년 10개월)입니다.

### 🔔 김창성 포트폴리오
> - 🚀 GitHub Profile : https://github.com/Kim-src
> - 🌐 LinkedIn Profile : https://www.linkedin.com/in/chang-seong-kim-7826142a0
> - ✅ Velog Blog :  https://velog.io/@kim-src/series
...
> - STS3의 java, jsp, xml 파일과 MySQL의 DB에 대한 연동 시도중(백엔드)
...
### 🔔 STS를 활용한 웹 개발 프로젝트
### 🚀 Book Rental Service 웹 개발
> - STS 3 및 Tomcat 9을 활용한 메인 페이지(Home) 구현 시도중
> - SQL 8을 활용한 고객 및 대여 리스트 DB 생성 완료
...
> - STS 우측 상단 "돋보기 모양"의 검색창 클릭
> - HTML Files, JSP Files 등 원하는 파일 확장자 클릭
> - Encoding 글자 옆 박스 클릭
...
### 📌 IntelliJ IDE에서 파일 import (코드 출력 결과 확인)
...
<!-- Contents -->
### 🔔 웹 개발 프로젝트 시작
> - Java & Spring 프로젝트 안내문에 기입된 내용 정리
> - 프로그램 제작을 위해 사용 예정인 IDE 종류 정리
